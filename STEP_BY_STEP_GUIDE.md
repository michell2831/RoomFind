...
### Hardware:
- ESP32 Development Board (for RFID Reader)
...
2. **ArduinoJson** (for WebSocket communication)
   - Search: "ArduinoJson"
   - Install by "Benoit Blanchon"
   
3. **WebSockets** (for WiFi communication)
   - Search: "WebSockets"
...
5. **Adafruit GFX Library** (for OLED graphics)
