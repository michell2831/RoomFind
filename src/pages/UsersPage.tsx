            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    <option value="faculty" style={{ color: '#ffffff', backgroundColor: '#0F1729' }}>Faculty</option>
                    <option value="admin" style={{ color: '#ffffff', backgroundColor: '#0F1729' }}>Admin</option>
                  </select>
                </div>
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-[#00D4AA]/50"
                  >
                    <option value="active" style={{ color: '#ffffff', backgroundColor: '#0F1729' }}>Active</option>
                    <option value="inactive" style={{ color: '#ffffff', backgroundColor: '#0F1729' }}>Inactive</option>
                  </select>
                </div>
              </div>
              <div>
