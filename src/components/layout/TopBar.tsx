...
import { Bell, RefreshCw, Signal, Menu, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function TopBar({ isPolling, lastUpdated, onToggleSidebar, collapsed, onToggleCollapse, onRefresh }: TopBarProps) {
  const location = useLocation();
  const page = pageTitles[location.pathname] || { title: "Room Find", subtitle: "" };

  return (
    <header className="h-14 bg-[#0F1729]/90 backdrop-blur border-b border-white/5 flex items-center justify-between px-4 sm:px-6 sticky top-0 z-40">
