...
const navItems: NavItem[] = [
  ...
  { label: "Rooms", path: "/rooms", icon: <DoorOpen size={18} /> },
  { label: "Users", path: "/users", icon: <Users size={18} /> },
  { label: "Schedules", path: "/schedules", icon: <Calendar size={18} /> },
  { label: "Access Logs", path: "/logs", icon: <FileText size={18} /> },
  { label: "RFID Cards", path: "/rfid", icon: <CreditCard size={18} /> },
  { label: "IoT Dashboard", path: "/iot", icon: <Wifi size={18} /> },
];
    ...
    <>
      {isOpen && (
        <div className="fixed inset-0 z-50 sm:hidden">
          ...
          <aside className="absolute left-0 top-0 h-full w-60 bg-[#0F1729] flex flex-col border-r border-white/5">
      ...
      <aside className={cn(
        "hidden sm:fixed sm:left-0 sm:top-0 sm:h-full sm:bg-[#0F1729] sm:flex sm:flex-col sm:z-50 sm:border-r sm:border-white/5",
        collapsed ? "sm:w-16" : "sm:w-60"
      )}>
      {/* Logo */}
      <div className={cn("border-b border-white/5", collapsed ? "px-2.5 py-4" : "px-5 py-5")}>
      ...
      {/* User */}
      <div className={cn("border-t border-white/5 pt-3", collapsed ? "px-1.5 pb-4" : "px-3 pb-4")}>
