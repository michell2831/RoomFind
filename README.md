...
#### Installation:
1. Open `esp32_room_sensor/esp32_room_sensor.ino` in Arduino IDE
2. Update WiFi credentials and server IP
3. Upload to ESP32
4. Device will auto-connect to WebSocket server
...
- **RFID**: Scan RFID card near reader
- **Sensors**: Move in front of PIR sensor, open/close door
